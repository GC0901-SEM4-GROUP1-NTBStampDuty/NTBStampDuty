        ...
        <div class="login_content">
            <div class="login_auth_dialog">
                ...
                <form class="login_auth" action="login" method="post">
                    <input id="login_input" type="text" name="username" placeholder="Username"  maxlength="15" required="true"/><br/>
                    <input id="login_input" type="password" name="password" placeholder="Password"  maxlength="20" required="true"/><br/>
